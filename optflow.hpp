...
Image<FVector<float, 2>, 2 > flow_Horn_Schunk_HuberL1(Image<FVector<float, 3> >& I1, Image<FVector<float, 3> >& I2, int iter_max = 50, float lambda = 1, float theta = 0.0002, float alpha = 1, float beta = 1, float epsilon = 0.1);
